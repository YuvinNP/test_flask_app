...
output = GetDetailsOfCluster("correct_cluster.csv",1200000,'all',0)

Df_dataset['reserved_room_type'].isna().sum()
...
CalTotalGivenTimeRange([2015, 2017], ['January', 'August', 'July', 'October', 'February'], [1])
